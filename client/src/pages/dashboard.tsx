...
import { Plus, Minus, TrendingUp, TrendingDown, BarChart3, Users, WalletIcon, Tag, ArrowLeft, Bell, FileText, PieChart, Eye, EyeOff, CreditCard, Settings, Download } from "lucide-react";
...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <BottomNav
        onOpenTransactionModal={(type) => setTransactionModal({ open: true, type })}
      />
    </div>
  );
}